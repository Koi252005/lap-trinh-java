...
import { getFeatureIcon } from '@/lib/productIcons';
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
                    ...
                    <ScrollAnimation direction="up" delay={100}>
                        ...
                        <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold mb-6 leading-tight">
                            <span className="pixel-icon w-20 h-20 md:w-24 md:h-24 mx-auto mb-4 bg-[var(--beige-cream)] border-[var(--gray-800)] flex items-center justify-center p-1 text-6xl">
                                🌾
                            </span>
                    ...
                    <ScrollAnimation direction="up" delay={400}>
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
                            {stats.map((stat, index) => (
                                ...
                                >
                                    <div className="pixel-icon w-14 h-14 mb-3 bg-white/80 flex items-center justify-center p-0.5 text-4xl" style={{ animationDelay: `${index * 0.2}s` }}>
                                        {stat.icon}
                                    </div>
                        ...
                        {features.map((feature, index) => (
                            <ScrollAnimation key={index} direction="up" delay={index * 100}>
                                <div className={`pixel-card ${feature.bgColor} p-8 hover-lift transition-all`}>
                                    <div className={`pixel-icon w-20 h-20 bg-gradient-to-br ${feature.color} flex items-center justify-center mb-6 p-1 text-5xl`}>
                                        {feature.icon}
                                    </div>
                            ...
                            <ScrollAnimation key={index} direction="up" delay={index * 100}>
                                <div className="text-center relative z-10">
                                    <div className="relative inline-block mb-6">
                                        <div className="pixel-icon w-20 h-20 bg-[var(--green-fresh)] flex items-center justify-center p-1 text-5xl">
                                            {item.icon}
                                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                        <div>
                            <div className="flex items-center gap-3 mb-4">
                                <div className="pixel-icon w-12 h-12 bg-[var(--green-fresh)] flex items-center justify-center p-0.5 text-3xl">
                                    🌾
                                </div>
